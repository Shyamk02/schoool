...
export default function MobileBottomNav() {
  ...
  const navItems: NavItem[] = [
    ...
    { href: "/student/grades", label: "Report", icon: <FileText className="h-5 w-5" /> },
    { href: "/student/video-lesson", label: "Lessons", icon: <BookOpen className="h-5 w-5" /> },
    { 
                  ...
                  >
                    <div className="relative">
                      ...
                      {isActive && (
                        <motion.div
                          layoutId="nav-pill"
                          className="absolute -top-3 left-1/2 transform -translate-x-1/2 h-1 w-10 bg-[#9716fb] rounded-full"
                      ...
                      <motion.div
                        ...
                        className={cn(
                          ...
                          isActive ? "text-[#9716fb]" : "text-muted-foreground"
                        )}
                      >
                        <div className="relative">
                          ...
                          {isActive && (
                            <motion.div
                              ...
                              className="absolute inset-0 bg-[#9716fb]/15 rounded-full -z-0"
                              initial={{ scale: 0 }}
                              animate={{ scale: 1 }}
                        ...
                        <AnimatePresence mode="wait">
                          <motion.span
                            ...
                            className={cn(
                              ...
                              isActive ? "text-[#9716fb] font-semibold" : "text-muted-foreground"
                            )}
                          >
                            {item.label}
                          </motion.span>
